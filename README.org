...
3) Other changes
  ...
  - The quality of the automatically generated keys has been improved:
       ...
       + German, French and Spanish articles added to ('the' and 'a') for exclusion from TITLEWORD
...
** Proposed to Zotero
This is a version with what I think are uncontroversial changes which the stock Zotero BibTeX export could usefully adopt. (BibTeX key improvements only, ATM)  A patch for these has been submitted to Zotero-dev and is awaiting approval.
